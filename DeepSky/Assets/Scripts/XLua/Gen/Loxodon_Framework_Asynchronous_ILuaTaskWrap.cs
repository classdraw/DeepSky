...
namespace XLua.CSObjectWrap
{
    ...
    public class LoxodonFrameworkAsynchronousILuaTaskWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Loxodon.Framework.Asynchronous.ILuaTask);
			Utils.BeginObjectRegister(type, L, translator, 0, 3, 1, 0);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetResult", _m_GetResult);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetException", _m_GetException);
        ...
        {
            return LuaAPI.luaL_error(L, "Loxodon.Framework.Asynchronous.ILuaTask does not have a constructor!");
        }
        ...
        static int _m_GetResult(RealStatePtr L)
        {
		    try {
                ...
                Loxodon.Framework.Asynchronous.ILuaTask gen_to_be_invoked = (Loxodon.Framework.Asynchronous.ILuaTask)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetException(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetException(  );
