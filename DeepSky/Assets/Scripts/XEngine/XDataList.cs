...
namespace XEngine
{
    public class XDataList
    {
        ...
        public virtual void Clear() { mList.Clear(); }
        ...
        public virtual void AddInt(int it)
        {
            this.Add(it);
        }

        public virtual void Add(params object[] param)
        {
        ...
        {
            get { return GetItemAt(i); }
            set { SetItemAt(i,value); }
        }

        public virtual object GetItemAt(int i)
        {
            return mList[i];
        }
        public virtual BetterList<object> GetAllItem()
        {
            return mList;
        }
        ...
        //lua have only double number,so indexof can not work.
        public virtual int IntIndexOf(int item)
        {
            return mList.IndexOf(item);
        }
