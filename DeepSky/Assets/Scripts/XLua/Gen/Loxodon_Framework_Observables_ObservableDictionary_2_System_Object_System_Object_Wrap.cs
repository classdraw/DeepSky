...
namespace XLua.CSObjectWrap
{
    ...
    public class LoxodonFrameworkObservablesObservableDictionary_2_SystemObjectSystemObject_Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Loxodon.Framework.Observables.ObservableDictionary<object, object>);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Loxodon.Framework.Observables.ObservableDictionary<object, object>();
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.IDictionary<object, object>>(L, 2))
				{
					...
					var gen_ret = new Loxodon.Framework.Observables.ObservableDictionary<object, object>(_dictionary);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.IEqualityComparer<object>>(L, 2))
				{
					...
					var gen_ret = new Loxodon.Framework.Observables.ObservableDictionary<object, object>(_comparer);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					var gen_ret = new Loxodon.Framework.Observables.ObservableDictionary<object, object>(_capacity);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<System.Collections.Generic.IDictionary<object, object>>(L, 2) && translator.Assignable<System.Collections.Generic.IEqualityComparer<object>>(L, 3))
				{
					...
					var gen_ret = new Loxodon.Framework.Observables.ObservableDictionary<object, object>(_dictionary, _comparer);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<System.Collections.Generic.IEqualityComparer<object>>(L, 3))
				{
					...
					var gen_ret = new Loxodon.Framework.Observables.ObservableDictionary<object, object>(_capacity, _comparer);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Observables.ObservableDictionary<object, object> constructor!");
        ...
        static int _m_get_Item(RealStatePtr L)
        {
		    try {
                ...
                Loxodon.Framework.Observables.ObservableDictionary<object, object> gen_to_be_invoked = (Loxodon.Framework.Observables.ObservableDictionary<object, object>)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Add(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Observables.ObservableDictionary<object, object>.Add!");
        ...
        static int _m_Remove(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Observables.ObservableDictionary<object, object>.Remove!");
        ...
        static int _e_PropertyChanged(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Observables.ObservableDictionary<object, object>.PropertyChanged!");
            return 0;
        }
        ...
        static int _e_CollectionChanged(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Observables.ObservableDictionary<object, object>.CollectionChanged!");
            return 0;
        }
