...
namespace UnityEngine.UI.Extensions
{
	...
	public class UILineRenderer : UIPrimitiveBase
	{
        ...
        public bool needUv = false;

        public Vector2[] uvList = new Vector2[4] { new Vector2(1,1), new Vector2(1, 0), new Vector2(0, 0), new Vector2(0, 1) };
		...
		protected override void OnPopulateMesh(VertexHelper vh)
		{
            ...
            for (var i = 0; i < segments.Count; i++)
			{
                ...
                if (needUv)
                {
                    segments[i][0].uv0 = uvList[0];
                    segments[i][1].uv0 = uvList[1];
                    segments[i][2].uv0 = uvList[2];
                    segments[i][3].uv0 = uvList[3];
                }
