...
namespace DG.Tweening
{
	public static class DOTweenModuleUI
    {
        ...
        public static Tweener DOText(this Text target, string startValue, string endValue, float duration, bool richTextEnabled = true, ScrambleMode scrambleMode = ScrambleMode.None, string scrambleChars = null)
        {
            string tmpCurrentValue = string.Empty;
            return DOTween.To(() => tmpCurrentValue, x => {
                tmpCurrentValue = x;
                target.text = startValue + tmpCurrentValue;
                }, endValue, duration)
                .SetOptions(richTextEnabled, scrambleMode, scrambleChars)
                .SetTarget(target);
        }
