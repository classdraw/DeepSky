...
namespace XLua.CSObjectWrap
{
    ...
    public class LoxodonFrameworkObservablesObservableList_1_SystemObject_Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Loxodon.Framework.Observables.ObservableList<object>);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Loxodon.Framework.Observables.ObservableList<object>();
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.List<object>>(L, 2))
				{
					...
					var gen_ret = new Loxodon.Framework.Observables.ObservableList<object>(_list);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Observables.ObservableList<object> constructor!");
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable<Loxodon.Framework.Observables.ObservableList<object>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					
					Loxodon.Framework.Observables.ObservableList<object> gen_to_be_invoked = (Loxodon.Framework.Observables.ObservableList<object>)translator.FastGetCSObj(L, 1);
        ...
        public static int __NewIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<Loxodon.Framework.Observables.ObservableList<object>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<object>(L, 3))
				{
        ...
        static int _e_PropertyChanged(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Observables.ObservableList<object>.PropertyChanged!");
            return 0;
        }
        ...
        static int _e_CollectionChanged(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Observables.ObservableList<object>.CollectionChanged!");
            return 0;
        }
