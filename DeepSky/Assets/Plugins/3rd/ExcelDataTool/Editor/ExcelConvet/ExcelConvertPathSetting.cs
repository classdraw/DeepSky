...
namespace XFramework.ExcelData.Editor
{
    public static class ExcelConvertPathSetting
    {
        ...
        /// 插件路径
        /// </summary>
        public const string PluginPath = "Assets/Plugins/3rd/ExcelDataTool/";
        ...
        /// 代码生成路径
        /// </summary>
        public const string GenerateCSFilePath = "/Assets/Scripts/Game/Data/Custom/";

        /// <summary>
        /// asset数据生成路径
        /// </summary>
        public const string ASSET_OUTPUT_PATH = "Assets/Editor/MyGameAssets/GameRes/ExcelData/";
