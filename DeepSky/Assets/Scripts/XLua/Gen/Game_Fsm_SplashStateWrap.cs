...
namespace XLua.CSObjectWrap
{
    ...
    public class GameFsmSplashStateWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Game.Fsm.SplashState);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<XEngine.Fsm.BaseFsm>(L, 2))
				{
					...
					var gen_ret = new Game.Fsm.SplashState(_fsm);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Game.Fsm.SplashState constructor!");
        ...
        static int _m_Enter(RealStatePtr L)
        {
		    try {
                ...
                Game.Fsm.SplashState gen_to_be_invoked = (Game.Fsm.SplashState)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_Index(RealStatePtr L)
        {
		    try {
			    ...
			    LuaAPI.xlua_pushinteger(L, Game.Fsm.SplashState.Index);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_Index(RealStatePtr L)
        {
		    try {
			    ...
			    Game.Fsm.SplashState.Index = LuaAPI.xlua_tointeger(L, 1);
